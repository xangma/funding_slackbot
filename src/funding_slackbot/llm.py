...
Do not narrow the criteria to a subset: health, public health, biomedical research, climate, space, data infrastructure, research software, robotics, and AI can each qualify when supported by the opportunity text.
The absence of exclusions, a broadly relevant funder/source, or generic career/chair/fellowship/scheme wording is not enough to match.
